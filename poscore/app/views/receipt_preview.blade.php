...
$(document).ready(function(){
	...
	$.each($('.cart-place tbody tr').clone(), function(index, tr){
		$('#receipt_items tbody').append('<tr><td class="r_qty">'+$(tr).find('td.quantity > input').val()+' x</td><td class="r_desc">'+$(tr).find('td.productname').text()+'</td><td class="r_upr">'+$(tr).find('td.unitprice').text()+'</td><td class="r_ttl">'+$(tr).find('td.total').text()+'</td></tr>');
	});
