	...
	<div class="row-fluid">
		<div class="span12">
			<div class="offset3 span6 offset3 widget-box">
				{{Form::open(array('route'=>'expenditure.save', 'id'=>'createexpenditure', 'class'=>'form-inline'))}}
					...
					<div class="row-fluid">
						<div class="span12">
								...
								<div class="control-group">
									...
									<div class="controls">
{{Form::text('date','', array('class'=>'span12', 'id'=>'date', 'autocomplete'=>'off', 'validate'=>'required'))}}
									</div>
								</div>
