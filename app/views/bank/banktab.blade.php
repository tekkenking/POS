		...
		<div class="widget-header">
			...
			<div class="widget-toolbar no-border">
				<ul id="myTab2" class="nav nav-tabs">
					<li class="active">
						<a href="#viewentries" data-toggle="tab" class="ajaxable" data-mode="viewentries" data-url={{URL::route('sale_entries')}}>View entries</a>
					</li>

					<li>
						<a href="#newentry" data-toggle="tab" class="ajaxable" data-mode="newentry" data-url={{URL::route('sale_entries')}}>New entry</a>
					</li>
				</ul>
			</div>
		</div>
...
$(function(){
	...
	$('#frontpageTopmenu > li.active > ul li').eq(1).addClass('active');
