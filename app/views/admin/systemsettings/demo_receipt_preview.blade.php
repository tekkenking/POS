		...
		<div class="span12">
			...
			<div id="receipt_details" style="border-bottom:1px solid #000;">
				...
				<div class="pull-right">
					<span>Shopping date:</span> <span id="receipt_date">{{ng_date_format()}}</span><br>
					<span>Shopping time:</span> <span id="receipt_time">{{ng_time_format()}}</span><br>
				</div>
				...
				<table class="table">
					...
					<tbody style="">
						<tr>
							...
							<td class="r_upr"> <span>{{currency()}}1,400.00k</span> </td>
							<td class="r_ttl"> <span>{{currency()}}2,800.00k</span> </td>
						</tr>
					</tbody>
				</table>
			</div>
			...
			<div id="receipt_payment" style="border-bottom:1px solid #000;">
				<h6 class="totaltendered bolder nomargin-top-bottom">
					...
					<span>{{currency()}}<span id="receipt_totalamountdue">2,800.00</span>k</span>
				</h6>

				<h6 class="totaltendered bolder nomargin-top-bottom">
					<span class="" id="receipt_totalamounttendered_word">Total amount tendered: </span>
					<span>{{currency()}}<span id="receipt_totalamounttendered">3,000.00</span>k</span>
				</h6>

				<h6 class="change bolder nomargin-top-bottom">
					<span class="" id="receipt_change_word">Change: </span>
					<span class="">{{currency()}}<span id="receipt_change">200.00</span>k</span>
				</h6>
			</div>
