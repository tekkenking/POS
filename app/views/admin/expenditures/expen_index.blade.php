		...
		<div class="widget-header">
			...
			<div class="widget-toolbar no-border">
				<ul id="myTab2" class="nav nav-tabs">
					<li class="active">
						<a href="#view" data-toggle="tab" class="ajaxable" data-mode="view" data-url={{URL::route('expenditures')}}> View </a>
					</li>

					<li>
						<a href="#create" data-toggle="tab" class="ajaxable" data-mode="create" data-url={{URL::route('expenditures')}}> Create </a>
					</li>
				</ul>
			</div>
		</div>
			...
			<div class="widget-main padding-12 no-padding-left no-padding-right">
				<div class="tab-content padding-4">
					<div class="tab-pane in active" id="view">
						...
						@include('admin.expenditures.expen_view')
...
$(function(){
	...
	$('#adminTopmenu > li.active > ul li').eq(3).addClass('active');
