...
Route::get('/clearcart', array('uses' => 'ReceiptController@clearCart', 'as' => 'clearcart'));
...
Route::get('/suspendcart', ['uses' => 'CartController@suspendCart', 'as' => 'suspendcart']);
Route::get('/resumecart/{key}', ['uses' => 'CartController@resumeCart', 'as' => 'resumecart']);
Route::get('/removesuspended/{key}', ['uses' => 'CartController@removeSuspended', 'as' => 'removesuspended']);
Route::get('/previewsuspended/{key}', ['uses' => 'CartController@previewSuspended', 'as' => 'previewsuspended']);
